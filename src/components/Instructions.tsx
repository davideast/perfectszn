  ...
  return (
    <section class="px-4 py-8 text-black bg-white rounded-sm szn-instructions">
      ...
      <p class="leading-loose szn-instructions__text">
        What would make the perfect season for the Denver Nuggets? The easy answer is a championship, but in this game you have to pick the piece that would make that championship happen.
      </p>
    </section>    
  );
}
